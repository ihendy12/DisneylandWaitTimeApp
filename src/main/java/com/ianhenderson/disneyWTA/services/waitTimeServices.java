package com.ianhenderson.disneyWTA.services;

import com.ianhenderson.disneyWTA.models.Times;
import org.springframework.http.*;
import org.springframework.web.client.ResourceAccessException;
import org.springframework.web.client.RestClientResponseException;
import org.springframework.web.client.RestTemplate;

public class waitTimeServices {
    ...
    public Times[] getAllAuctions() {
        Times[] auctions = null;
        try {
            ResponseEntity<Times[]> response =
                    restTemplate.exchange(API_BASE_URL, HttpMethod.GET, makeAuthEntity(), Times[].class);
